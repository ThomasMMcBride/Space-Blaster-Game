...
public class BackgroundLoop : MonoBehaviour {
    ...
    // for every background image, load the image onto the screen
    void Start() {
   ...
   // create clones of images and positions them so that they fill the screen
    void loadChildObjects(GameObject obj) {
        float objectWidth = obj.GetComponent<SpriteRenderer>().bounds.size.x - choke;
        // determine how many consecutive images are needed to fill the screen
    ...
    // updates position of image children
    void LateUpdate() {
        foreach(GameObject obj in levels) {
    ...
    // repositions image children depending on the position of the camera
