...
public class CreateRedEnemies : MonoBehaviour
{
    ...
    void Start() {
        ...
        StartCoroutine(redEnemySpawner()); // initate meteor spawning coroutine
    ...
    private void spawnEnemy() {
        GameObject a = Instantiate(redEnemy) as GameObject;
